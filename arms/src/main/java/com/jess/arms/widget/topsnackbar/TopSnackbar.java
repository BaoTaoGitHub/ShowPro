...
package com.jess.arms.widget.topsnackbar;
...
public final class TopSnackbar extends BaseTransientBottomBar<TopSnackbar> {
    ...
    public static TopSnackbar make(@NonNull View view, @NonNull CharSequence text,
                                   @Duration int duration, @Slide.GravityFlag int gravity) {
    ...
    public static TopSnackbar make(@NonNull View view, @NonNull CharSequence text,
        ...
        final SnackbarContentLayout content =
                (SnackbarContentLayout) inflater.inflate(
                        R.layout.design_layout_topsnackbar_include, parent, false);
        TopSnackbarGravity = Gravity.TOP;
        final TopSnackbar snackbar = new TopSnackbar(parent, content, content);
        snackbar.setText(text);
        snackbar.setDuration(duration);
        return snackbar;
     ...
     * @return
     */
    public TopSnackbar setMessageColor(@ColorInt int messageColor) {
     ...
     * @return
     */
    public TopSnackbar setBackgroundColor(@ColorInt int backgroundColor) {
        View view = this.getView();
        if (view != null) {
     ...
     * @return
     */
    public TopSnackbar setTopSnackbarColor(@ColorInt int messageColor,@ColorInt int backgroundColor) {
        View view = this.getView();
        if (view != null) {
            view.setBackgroundColor(backgroundColor);
            ((TextView) view.findViewById(R.id.snackbar_text)).setTextColor(messageColor);
