...
import static com.jess.arms.widget.topsnackbar.AnimationUtils.FAST_OUT_SLOW_IN_INTERPOLATOR;
...
public abstract class BaseTransientBottomBar<B extends BaseTransientBottomBar<B>> {
    ...
    protected static int TopSnackbarGravity = Gravity.TOP;
    ...
    protected BaseTransientBottomBar(@NonNull ViewGroup parent, @NonNull View content,
        ...
        if (TopSnackbarGravity == Gravity.BOTTOM) {
            mView = (SnackbarBaseLayout) inflater.inflate(
                    R.layout.design_layout_topsnackbar_bottom, mTargetParent, false);
        } else {
            mView = (SnackbarBaseLayout) inflater.inflate(
